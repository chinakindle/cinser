...
namespace Cinser.BaseLib.Log
{
    public class LogManager
    {
        ...
        /// <summary>
        /// The wrapper map to use to hold the <see cref="CinserLogImpl"/> objects
        /// </summary>
        ...
        public static ICinserLog Exists(string name)
        {
        ...
        /// <param name="name">The fully qualified logger name to look for</param>
        /// <returns>The logger found, or null</returns>
        public static ICinserLog Exists(string domain, string name)
        {
        ...
        /// <param name="name">The fully qualified logger name to look for</param>
        /// <returns>The logger found, or null</returns>
        public static ICinserLog Exists(Assembly assembly, string name)
        {
        ...
        public static ICinserLog[] GetCurrentLoggers()
        {
        ...
        /// </remarks>
        /// <returns>All the defined loggers</returns>
        public static ICinserLog[] GetCurrentLoggers(string domain)
        {
        ...
        /// </remarks>
        /// <returns>All the defined loggers</returns>
        public static ICinserLog[] GetCurrentLoggers(Assembly assembly)
        {
        ...
        public static ICinserLog GetLogger(string name)
        {
        ...
        /// <param name="name">The name of the logger to retrieve.</param>
        /// <returns>the logger with the name specified</returns>
        public static ICinserLog GetLogger(string domain, string name)
        {
        ...
        /// <param name="name">The name of the logger to retrieve.</param>
        /// <returns>the logger with the name specified</returns>
        public static ICinserLog GetLogger(Assembly assembly, string name)
        {
        ...
        /// <returns>the logger with the name specified</returns>
        public static ICinserLog GetLogger(Type type)
        {
        ...
        /// be used as the name of the logger to retrieve.</param>
        /// <returns>the logger with the name specified</returns>
        public static ICinserLog GetLogger(string domain, Type type)
        {
        ...
        /// be used as the name of the logger to retrieve.</param>
        /// <returns>the logger with the name specified</returns>
        public static ICinserLog GetLogger(Assembly assembly, Type type)
        {
        ...
        private static ICinserLog WrapLogger(ILogger logger)
        {
            return (ICinserLog)s_wrapperMap.GetWrapper(logger);
        }
        ...
        private static ICinserLog[] WrapLoggers(ILogger[] loggers)
        {
            ICinserLog[] results = new ICinserLog[loggers.Length];
        ...
        {
            return new CinserLogImpl(logger);
        }
